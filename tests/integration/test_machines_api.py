...
class TestMachinesAPI:
    ...
    def test_delete_machine_user_requires_authentication(self, test_client):
        """Test that DELETE /machines/<id>/users/<user_id> requires authentication."""
        response = test_client.delete("/api/v1/machines/1/users/1")
        assert response.status_code == 401

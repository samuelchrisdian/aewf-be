...
def get_students(current_user):
    ...
    sort_by, order = validate_sort_params(sort_by, order, ["name", "nis", "class_id"])
...
def get_student(current_user, nis):
    ...
    return success_response(data=student_data, message="Student retrieved successfully")
...
def create_student(current_user):
    ...
    return created_response(data=student_data, message="Student created successfully")
...
def update_student(current_user, nis):
    ...
    return success_response(data=student_data, message="Student updated successfully")
